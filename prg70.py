...
class App:  # класс приложения
    def __init__(self):
        ...
        self.btn = Button(text='Появись')
        self.btn.pack(side=LEFT, anchor=N, padx=25, fill=X, expand=True) #прикреплена к левой части и растянута на весь экран
    ...
    def make_rect(self):
        self.canvas.create_rectangle(0,0,600,400, outline='#004440', fill='yellow', width=5)
